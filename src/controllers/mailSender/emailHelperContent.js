            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="email-body">
                        ...
                        <br><br>
                        <a href="http://localhost:5050/api/v1/auth/reset-password/${this.token}" class="email-link" style="color: white !important;">Reset Password</a>
                        <br><br>
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="email-body">
                        ...
                        <br><br>
                        <a href="http://localhost:5050/api/v1/auth/reset-password/${this.token}" class="email-link" style="color: white !important;">Réinitialiser le mot de passe</a>
                        <br><br>
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="email-body">
                        ...
                        <br><br>
                        <a href="http://localhost:5050/api/v1/auth/account-activation/${this.token}" class="email-link" style="color: white !important;">Verify Email</a>
                        <br><br>
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="email-body">
                        ...
                        <br><br>
                        <a href="http://localhost:5050/api/v1/auth/account-activation/${this.token}" class="email-link" style="color: white !important;">Vérifier l'e-mail</a>
                        <br><br>
